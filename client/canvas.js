...
(function(app) {
    ...
    function initializeCanvas() {
        ...
        window.addEventListener('resize', () => {
            ...
            // Redraw from history to ensure correct scaling and positioning
            redrawAll(history);
        });
    }
    ...
    function handlePointerDown(e) {
        ...
        applyPathOptions({ tool: currentTool, options: { color: currentColor, strokeWidth: currentStrokeWidth } });
    }
    ...
    app.canvas = { initializeCanvas, setTool, setColor, setStrokeWidth, redrawAll, drawStroke };
